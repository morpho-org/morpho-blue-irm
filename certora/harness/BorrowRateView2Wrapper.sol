...
import {ACIBorrowRateView2Lib} from "../../src/adaptive-curve-irm/libraries/periphery/ACIBorrowRateView2Lib.sol";
...
contract BorrowRateView2Wrapper {
    ...
    function borrowRateView2(Id id, Market memory market, address adaptiveCurveIrm) external view returns (uint256) {
        return ACIBorrowRateView2Lib.borrowRateView2(id, market, adaptiveCurveIrm);
    }
